...
def main():
    ...
    oi.init_simulation_by_path( Path("/Volumes/staff-umbrella/Confidential data HKN/Yaw_Steering_Experiments/2026_06_18_LUTs_Phase_One/OFF_HKN_Wake_Steering_Test_Phase_One_BL_FLORIS_GCH.yaml") )
